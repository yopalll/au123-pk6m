...
func guessCategory(name string) string {
	...
	return "Nails" // default for nail-category Excel
}
...
func main() {
	...
	excelFile = filepath.Join(baseDir, "SCRAP", "nail_allcategory_uk.xlsx")
	...
	for i, row := range rows {
		...
		if desc == "" {
			desc = salonName + " is a professional nail and beauty salon."
		}
